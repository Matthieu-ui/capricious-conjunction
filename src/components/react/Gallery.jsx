...
const Gallery = () => {
    ...
    return (
        <>
            ...
            <li className="mx-auto rounded-lg w-full drop-shadow-lg overflow-hidden duration-300 group relative border border-accent  bg-zinc-200 p-2 ring-accent transition-all hover:ring-1 dark:bg-zinc-900">
